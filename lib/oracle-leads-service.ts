...
export async function consultarLeads(
  ...
  console.log('🔍 [Oracle] Consultando leads:', { idEmpresa, codUsuario, isAdmin, dataInicio, dataFim, codVendedor, vendedoresEquipe });
...
export async function consultarAtividades(codLead: string, idEmpresa: number, ativo: string = 'S', codUsuario?: number): Promise<any[]> {
  console.log('🔍 [Oracle] Consultando atividades:', { codLead, idEmpresa, ativo, codUsuario });
